...
class studentlogin extends StatefulWidget {
  @override
  _studentlogin createState() => _studentlogin();
}
              ...
              child: Container(
                child: Column(
                  children:<Widget> [
                    ...
                    Material(
                      elevation: 10,
                        child: Image(image: AssetImage('images/proffimage.png')
                          ,height: MediaQuery.of(context).size.height * 0.2,
                          width: MediaQuery.of(context).size.height * 0.2,
                        ),shape: CircleBorder(),
                    ),
                    SizedBox(height: 20,),
                    Text("Welcome back Symbian!",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.white),),
